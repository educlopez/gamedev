...
export function HouseIcon(props: ComponentPropsWithoutRef<"svg">) {
  return (
    <svg
      fill="none"
      viewBox="0 0 20 20"
...
export function CrossIcon(props: ComponentPropsWithoutRef<"svg">) {
  return (
    <svg fill="none" viewBox="0 0 90 90" {...props}>
      <path d="M0 0H18V18H0V0Z" fill="#071821" />
      <path d="M36 36H18V18H36V36Z" fill="#071821" />
      <path
        d="M54 36H36V54H18V72H0V90H18V72H36V54H54V72H72V90H90V72H72V54H54V36Z"
        fill="#071821"
      />
      <path d="M72 18V36H54V18H72Z" fill="#071821" />
      <path d="M72 18V0H90V18H72Z" fill="#071821" />
    </svg>
  );
}

export function CircleIcon(props: ComponentPropsWithoutRef<"svg">) {
  return (
    <svg fill="none" viewBox="0 0 87 87" {...props}>
      <path
        clipRule="evenodd"
